...
void creating_archive(Input *inp, ScoreOutput *out, AMOSAType *amosaParams)
{
    ...
    for(i=0;i<amosaParams->i_softl;i++)
    {
        evaluate(amosaParams->d_solution[i], amosaParams, inp, out);   /* This function calls different evaluation functions */
