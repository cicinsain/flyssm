...
int prolix;                     /* flag for printing stat info (prolix) */
...
Initialize( int argc, char **argv ) {
    ...
    files.prolixfile = ( char * ) calloc( MAX_RECORD, sizeof( char ) );
...
GetLamstats( void ) {
    ...
    stats[19] = D;
//    stats[20] = E; 
    stats[20] = D; //this is nonsens but I needed to put something
...
/** default simulated annealing algorithm params */
SAType
InitDefaultSA(  ) {
    ...
    in_tune.criterion = 0.0001;
    //in_tune.debuglevel = 0;
    in_tune.freeze_count = 5;
    in_tune.initial_moves = 100000;

    in_tune.lambda = 0.00001;
    in_tune.lambda_mem_length_u = 0.2;
    in_tune.lambda_mem_length_v = 100.0;
    //in_tune.progname = (char *)calloc(MAX_RECORD + 1, sizeof(char));
    //in_tune.progname = "";

    in_tune.tau = 100;
    //in_tune.tunefile = NULL;
    //in_tune.tunename =  "";

    in_tune.update_S_skip = 10;

#ifdef MPI
    in_tune.mix_interval = 25;
#endif
    return in_tune;
}
