...
main( int argc, char **argv ) {
    ...
    /*======
        Amir*/
    //int genPop=1;                  /*switch for generating the population */
    // FILE *popFile;          /* will store individuals of a population */
    ...
    if( outname != NULL ) {     /* -o used? */
        /*=====
            Amir: Avoid the scramble to overwrite the ouput file*/
        // if (!genPop)
        // {
        ...
        // }else{
        //     /*======
        //         Amir: Writing the parameters in order to the output file*/
        //     for( i = 0; i < ncols; ++i )
        //         if( inp.twe.Rtweak[i] == 1 )
        //             fprintf(popFile, "%f,", inp.zyg.parm.R[i]);

        //     for( i = 0; i < nrows; ++i )
        //         for( j = 0; j < ncols; j++ )
        //             if( inp.twe.Ttweak[( i * ncols ) + j] == 1 )
        //                 fprintf(popFile, "%f,", inp.zyg.parm.T[( i * ncols ) + j]);

        //     for( i = 0; i < nrows; ++i )
        //         for( j = 0; j < egenes; j++ )
        //             if( inp.twe.Etweak[( i * egenes ) + j] == 1 )
        //                 fprintf(popFile, "%f,", inp.zyg.parm.E[( i * egenes ) + j]);

        //     for( i = 0; i < ncols; ++i )
        //         if( inp.twe.mtweak[i] == 1 )
        //             fprintf(popFile, "%f,", inp.zyg.parm.m[i]);

        //     for( i = 0; i < ncols; ++i )
        //         if( inp.twe.htweak[i] == 1 )
        //             fprintf(popFile, "%f,", inp.zyg.parm.h[i]);

        //     for( i = 0; i < ncols; ++i )
        //         if( inp.twe.dtweak[i] == 1 )
        //             fprintf(popFile, "%f,", inp.zyg.parm.d[i]);

        //     // Not transformed value will be written to the file since, the scrambled_init_pop 
        //     // will not be read by ReadParamters and consequently the values shouldn't be transformed.
        //     for( i = 0; i < ncols; ++i )
        //         if( inp.twe.lambdatweak[i] == 1 )   
        //             fprintf(popFile, "%f,", /*log( 2. ) /*/ inp.zyg.parm.lambda[i]);

        //     for( i = 0; i < ncols; ++i )
        //         if( inp.twe.tautweak[i] == 1 )
        //             fprintf(popFile, "%f,", inp.zyg.parm.tau[i]);
